...
def test_2():
    ...
    assert callbacks == 10, "all callbacks executed"
...
def test_3():
    ...
    def changed_profile_cb5(_widget, _profile):
        ...
        # ( resolution, 50 )
        print(f"changed_profile_cb5 {dialog.current_scan_options}")
        assert dialog.current_scan_options == Profile(
            backend=backend
    ...
    def finished_process_cb(_widget, process):
        ...
        assert process == "set_option tl-x to 0", "finished-process set_option"
        nonlocal callbacks
        callbacks += 1
    ...
    assert callbacks == 8, "all callbacks executed"
