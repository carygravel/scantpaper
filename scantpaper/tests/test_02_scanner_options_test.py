...
def test_1():
    ...
    that = [
        ...
        },
        {
            ...
            "type": "TYPE_INT",
            "constraint": {"min": 1, "max": 1200, "quant": 1},
            "title": "Resolution",
        ...
        },
        {
            ...
            "type": "TYPE_INT",
            "constraint": {"min": 1, "max": 65536, "quant": 1},
            "constraint_type": "CONSTRAINT_RANGE",
        },
        {
            "cap": "CAP_SOFT_DETECT" + "CAP_SOFT_SELECT",
        ...
        },
        {
            ...
            "type": "TYPE_INT",
            "constraint": {"min": 1000, "max": 200000, "quant": 1000},
            "constraint_type": "CONSTRAINT_RANGE",
        },
        {
            "cap": "CAP_SOFT_DETECT" + "CAP_SOFT_SELECT",
        ...
        },
        {
            ...
            "type": "TYPE_INT",
            "constraint": {"min": -128, "max": 128, "quant": 1},
            "title": "Ppl loss",
            "constraint_type": "CONSTRAINT_RANGE",
        },
        {
        ...
        },
        {
            ...
            "type": "TYPE_INT",
            "constraint": {"min": 4, "max": 192, "quant": 2},
            "constraint_type": "CONSTRAINT_RANGE",
        },
        {
            "cap": "CAP_SOFT_DETECT" + "CAP_SOFT_SELECT" + "CAP_INACTIVE",
        ...
        },
        {
            ...
            "type": "TYPE_FIXED",
            "constraint": {"min": -42.17, "max": 32768.0, "quant": 2.0},
            "constraint_type": "CONSTRAINT_RANGE",
        },
        {
            "cap": "CAP_SOFT_DETECT" + "CAP_SOFT_SELECT" + "CAP_INACTIVE",
    ...
    assert within_tolerance(options.array[1], "value") is False, "SANE_CONSTRAINT_NONE"
    assert (
        within_tolerance(options.array[2], "Gray") is True
    ), "SANE_CONSTRAINT_STRING_LIST positive"
    assert (
        within_tolerance(options.array[3], 8) is True
    ), "SANE_CONSTRAINT_WORD_LIST positive"
    assert within_tolerance(options.array[7], 50) is True, "SANE_CONSTRAINT_RANGE exact"
    assert (
        within_tolerance(options.array[7], 50.1) is True
    ), "SANE_CONSTRAINT_RANGE inexact"
    assert (
        within_tolerance(options.array[2], "gray") is False
    ), "SANE_CONSTRAINT_STRING_LIST negative"
    assert (
        within_tolerance(options.array[3], 7) is False
    ), "SANE_CONSTRAINT_WORD_LIST negative"
    assert (
        within_tolerance(options.array[7], 51.1) is False
    ), "SANE_CONSTRAINT_RANGE negative"
    assert (
        within_tolerance(options.array[4], "") is True
    ), "SANE_TYPE_BOOL positive but empty string instead of 0"
    assert within_tolerance(options.array[4], 1) is False, "SANE_TYPE_BOOL negative"
    options.array[36]["val"] = 20
    assert within_tolerance(options.array[36], 20) is True, "SANE_TYPE_INT positive"
    assert within_tolerance(options.array[36], 21) is False, "SANE_TYPE_INT negative"
    options.array[43]["val"] = 20.5
    assert within_tolerance(options.array[43], 20.5) is True, "SANE_TYPE_FIXED positive"
    assert within_tolerance(options.array[43], 21) is False, "SANE_TYPE_FIXED negative"
    options.array[47]["val"] = "20.5"
    assert (
        within_tolerance(options.array[47], "20.5") is True
    ), "SANE_TYPE_STRING positive"
    assert (
        within_tolerance(options.array[47], "21") is False
    ), "SANE_TYPE_STRING negative"

    options = [
        None,
        {
            "cap": "CAP_SOFT_SELECT" + "CAP_SOFT_DETECT",
            "constraint": {"max": 297.179992675781, "min": 0.0, "quant": 0.0},
            "constraint_type": "CONSTRAINT_RANGE",
            "desc": "Top Left Y",
            "index": 14,
            "max_values": 1,
    ...
    assert (
        within_tolerance(options[1], 1, 0.001) is True
