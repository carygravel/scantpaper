...
"""
        ...
        assert canvas.get_last_bbox().text == "No", (
...
def test_canvas_indices():
    ...
    with patch("scantpaper.canvas.TreeIter") as mock_tree_iter:
...
def test_bbox_init_zero_width_text():
    ...
    with patch("scantpaper.canvas.logger"):
