...
def test_split_dialog_interaction(mocker, mock_tool_window):
    ...
    mocker.patch("scantpaper.tools_menu_mixins.Gtk.Box")
...
def test_ocr_dialog(mocker, mock_tool_window):
    ...
    mock_ocr_controls_cls = mocker.patch("scantpaper.tools_menu_mixins.OCRControls")
...
def test_email_dialog(mocker, mock_tool_window):
    ...
    mocker.patch(
        "scantpaper.tools_menu_mixins.expand_metadata_pattern", return_value="doc"
    )
    mocker.patch("scantpaper.tools_menu_mixins.collate_metadata", return_value={})
...
def test_email_execution_flow(mocker, mock_tool_window):
    ...
    mock_exec = mocker.patch(
        "scantpaper.tools_menu_mixins.exec_command", return_value=Proc(0, "", "")
    )
    mock_launch = mocker.patch("scantpaper.tools_menu_mixins.launch_default_for_file")
...
def test_email_default_filename(mocker, mock_tool_window):
    ...
    mocker.patch(
        "scantpaper.tools_menu_mixins.expand_metadata_pattern", return_value="   "
    )
    mocker.patch("scantpaper.tools_menu_mixins.collate_metadata", return_value={})
    mocker.patch(
        "scantpaper.tools_menu_mixins.exec_command", return_value=Proc(0, "", "")
    )
    mocker.patch("scantpaper.tools_menu_mixins.launch_default_for_file")
