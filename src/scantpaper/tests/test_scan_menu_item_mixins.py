...
def mock_scan_window(mocker):
    ...
    mocker.patch("scantpaper.scan_menu_item_mixins.Gtk")
    mocker.patch("scantpaper.scan_menu_item_mixins._", side_effect=lambda x: x)
...
def test_add_postprocessing_options_clicked_cb(mocker, mock_scan_window):
    ...
    mock_rotate_cls = mocker.patch("scantpaper.scan_menu_item_mixins.RotateControls")
    ...
    mock_ocr_cls = mocker.patch("scantpaper.scan_menu_item_mixins.OCRControls")
    ...
    mock_combo_cls = mocker.patch("scantpaper.scan_menu_item_mixins.ComboBoxText")
...
def test_reloaded_scan_options_callback(mocker, mock_scan_window):
    ...
    mock_profile_cls = mocker.patch("scantpaper.scan_menu_item_mixins.Profile")
    mock_scan_window._reloaded_scan_options_callback(mock_widget)
...
def test_changed_device_list_callback_cache_libusb_ok(mocker, mock_scan_window):
    ...
    mock_dialog_cls = mocker.patch("scantpaper.scan_menu_item_mixins.Gtk.MessageDialog")
